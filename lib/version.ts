...
const unsortedReleaseNotes: ReleaseNote[] = [
  ...
  },
  {
    ...
    summary: "هر تلاش پرداخت بله با مالکیت سامانه، فرصت زمانی مشخص و شروع دوباره امن مدیریت می‌شود؛ نهایی‌سازی قابل‌اعتماد، حفظ شواهد نامطمئن و بازیابی تراکنش برای مدیران پرداخت نیز تکمیل شد.",
