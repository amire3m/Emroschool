...
const unsortedReleaseNotes: ReleaseNote[] = [
  ...
  },
  {
    ...
    summary: "اطلاعات ۳۱ استان و شهرهای ایران از داده محلی سامانه بارگذاری می‌شود؛ انتخاب تهران پایدار شده و منطقه و محله تهران نیز بدون وابستگی به سرویس خارجی ثبت می‌شوند.",
  ...
  },
  {
    ...
    summary: "پرداخت بله با فرصت زمانی مشخص، انقضا و شروع دوباره امن، نهایی‌سازی قابل‌اعتماد و ابزار بازیابی تراکنش برای مدیران پرداخت تکمیل شد.",
