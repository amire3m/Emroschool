...
export async function issueBaleOtp(phone: string, purpose: "register" | "login" | "reset") {
...
export async function verifyBaleOtp(phone: string, code: string, purpose: "register" | "login" | "reset") {
  const destination = normalizeBalePhone(phone);
