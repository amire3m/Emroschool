                ...
                <tr key={user.id} className="border-b border-surface-variant last:border-0 hover:bg-surface-low/50 transition-colors">
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2 justify-end">
                      {(user.profileApprovalStatus === "pending" || user.avatarSubmissions?.[0]?.status === "pending") && <button onClick={() => setProfileReviewUser(user)} className="inline-flex items-center gap-1 rounded-lg bg-secondary px-2 py-1 text-xs font-bold text-white" title="مشاهده و بررسی پروفایل"><Eye size={14} /><span className="hidden xl:inline">بررسی</span></button>}
