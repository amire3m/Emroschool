...
const values: Record<string, string> = { pending: "در انتظار بررسی", awaiting_receipt: "در انتظار رسید", under_review: "نیازمند بررسی", paid: "موفق", rejected: "رد شده", expired: "منقضی", approved: "تأیید شده", pending_payment: "در انتظار بررسی", card_to_card: "کارت به کارت", bale_wallet: "کیف پول بله", manual: "پرداخت دستی", true: "بله", false: "خیر" };
